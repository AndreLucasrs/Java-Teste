...
public class EncerradorDeLeilaoTest {
	...
	public void deveEncerrarLeiloesQueComecaramUmaSemanaAntes() {
		...
		// Classe CriadorDeLeiao é uma classe Data Builder, que auxilia na hora do teste
		...
		// Objetos que simulam os comportamentos dos objetos reais é o que chamamos de
		// mock objects
		// criando um mock do objeto que queremos simular.
		LeilaoDao daoFalso = mock(LeilaoDao.class);

		// when() recebe o método que queremos simular,thenReturn() recebe o que o
		// método falso deve devolver
	...
	public void deveAtualizarLeiloesEncerrados() {
		...
		EncerradorDeLeilao encerradorDeLeilao = new EncerradorDeLeilao(daoFalso, carteiroFalso);
		encerradorDeLeilao.encerra();
		// verify(). Nele, indicaremos qual método que queremos verificar se foi
		// invocado
	...
	public void naoDeveEncerrarLeiloesQueComecaramMenosDeUmaSemanaAtras() {
		...
		// never(), vai verificar se o metodo não foi invocado nenhuma vez
		verify(daoFalso, never()).atualiza(leilao1);

		// outros casos
		// atLeastOnce() vai garantir que o método foi invocado no mínimo uma vez
		// atLeast(numero) funciona de forma análoga ao método acima, com a diferença de
		// que passamos para ele o número mínimo de invocações que um método deve ter.
		// atMost(numero) nos garante que um método foi executado até no máximo N vezes.
		// Ou seja, se o método tiver mais invocações do que o que foi passado para o
	...
	public void deveEnviarEmailAposPersistirLeilaoEncerrado() {
		...
		// InOrder, quer dizer que os testes serão verificados nesta ordem especifica
	...
	public void deveContinuarAExecucaoMesmoQuandoDaoFalha() {
		...
		when(daoFalso.correntes()).thenReturn(Arrays.asList(leilao1, leilao2));
		// queremos a execeção, quando daoFalso atualiza
	...
	public void deveDesistirSeDaoFalhaPraSempre() {
		...
		RepositorioDeLeiloes daoFalso = mock(RepositorioDeLeiloes.class);
		//when(daoFalso.correntes()).thenReturn(Arrays.asList(leilao1, leilao2));
		//Perceba que, para esses testes, não importa se é leilao1 ou leilao2. A exceção será lançada para qualquer leilão. Podemos escrever isso com apenas uma linha
...
//		verify(carteiroFalso, never()).envia(leilao2);
	...
	//Podemos, por exemplo, garantir que um mock vai ser chamado com uma String começando com "Importante:"
